...
//######################################################################################################################
                                ...
                                //---------------------------------------------------------------------------------                                 
                                #include "_SHADERS/depth/gl_FragCoord/gl_FragCoord_GLOBALS.cpp"
                                //---------------------------------------------------------------------------------
...
{    
        ...
        if(shaderNumber == 55)
        {    
            #include "_SHADERS/depth/gl_FragCoord/gl_FragCoord_RENDER.cpp"
...
//==========================================================================================================================================================================
        ...
        //-----------------------------------------------------------------------------                    
        #include "_SHADERS/depth/gl_FragCoord/gl_FragCoord_INIT.cpp"
        //-----------------------------------------------------------------------------                  
...
void shutDownGL( void )
{
        ...
        //====================================================================================                   
        #include "_SHADERS/depth/gl_FragCoord/gl_FragCoord_SHUTDOWN.cpp"    
        //====================================================================================                   
        ...
        //====================================================================================    
        #include "_MODEL_FOLDERS_/diamond/diamond_Shutdown.cpp"                                                                 
        //====================================================================================  
